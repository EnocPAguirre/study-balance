package proyecto.core.csv.processor.concurrent.parts.manager;
...
import proyecto.core.csv.processor.concurrent.parts.manager.execution.ConcurrentPartProcessor;
import proyecto.core.csv.processor.concurrent.parts.split.CsvSplitResult;
import proyecto.core.csv.processor.concurrent.parts.split.CsvSplitter;
import proyecto.core.csv.processor.concurrent.parts.manager.temp.TempDirectoryFactory;
import proyecto.core.csv.processor.concurrent.parts.util.CleanupDirectory;
import proyecto.core.csv.processor.concurrent.parts.util.CsvOutput;
import proyecto.core.csv.processor.concurrent.parts.util.NumPartsResolver;
...
public class CsvManager extends BaseCsvProcessor {
    ...
    public void processConcurrent(String inputPath,
        ...
        try {
            CsvSplitResult splitResult = splitter.split(inputFile, tempDir, numParts, separator);
            ...
            SummaryReporter.report("CONCURRENCIA LENTO",inputFile, outputFile, logFile, start, end);
